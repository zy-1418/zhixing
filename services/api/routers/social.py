...
public_router = APIRouter(tags=["social-public"])
...
@public_router.post("/debates", status_code=201)
...
@public_router.get("/debates/{debate_id}")
...
@public_router.post("/debates/{debate_id}/comments", status_code=201)
