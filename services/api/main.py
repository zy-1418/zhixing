...
from routers.extensions import public_router as extensions_public_router
from routers.extensions import router as extensions_router
from routers.notes import router as notes_router
from routers.social import public_router as social_public_router
...
app.include_router(social_public_router, prefix="/api/v1")
app.include_router(extensions_router, prefix="/api/v1")
app.include_router(extensions_public_router, prefix="/api/v1")
