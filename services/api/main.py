...
from routers.extensions import root_router as extensions_root_router
from routers.extensions import router as extensions_router
from routers.notes import router as notes_router
from routers.social import root_router as social_root_router
...
app.include_router(social_root_router, prefix="/api/v1")
app.include_router(extensions_router, prefix="/api/v1")
app.include_router(extensions_root_router, prefix="/api/v1")
