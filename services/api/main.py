...
from routers.extensions import compatibility_router as extensions_compatibility_router
from routers.extensions import router as extensions_router
from routers.notes import router as notes_router
from routers.social import compatibility_router as social_compatibility_router
...
app.include_router(social_compatibility_router, prefix="/api/v1")
app.include_router(extensions_router, prefix="/api/v1")
app.include_router(extensions_compatibility_router, prefix="/api/v1")
