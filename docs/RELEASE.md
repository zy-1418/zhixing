...
- 补齐任务详情、QA retry、日志快照、工作区树别名、会话显式 `.json`/`.md` 导出。
- 补齐 OpenIM、工作流模板、插件市场、搜索、个人主页、知识图谱、好友 AI、小程序、画布、双联 PDF、电商、购物车、桌面端根级占位端点。
- 保留 Cloud 环境不可用依赖的 blocked/placeholder 响应，方便本机服务恢复后替换为真实集成。
