...
- MetaGPT SOP 提交、公开任务状态查询、QA retry、任务日历、优先级队列占位、WS 日志代理。
...
for path in ["/health", "/api/v1/auth/register", "/api/v1/tasks/sop", "/api/v1/tasks/{id}", "/api/v1/tasks/{id}/retry", "/api/v1/dify/chat", "/api/v1/social/posts"]:
