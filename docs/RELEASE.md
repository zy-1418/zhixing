...
- 补齐最终验收路径别名：任务详情/重试、工作区树、会话 JSON/Markdown 导出、笔记尾斜杠列表、广场投票单数路径与根级辩论入口。
- 保留 `/extensions/*` 旧路径，同时提供根级 OpenIM、工作流模板、市场、搜索、个人主页、知识图谱、好友 AI、小程序、画布、双联 PDF、电商与桌面构建状态端点。
